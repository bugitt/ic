...
class TableTemplate(
    ...
    var id: Long = 1,
    @Column(name = "template_type", columnDefinition = "TINYINT(3) DEFAULT '0' COMMENT '模板类型'", nullable = false)
    var templateType: Int = 0,
    @Column(name = "template_name", columnDefinition = "VARCHAR(255) DEFAULT '' COMMENT '模板名称'", nullable = false)
    var templateName: String = "",
    @Column(name = "table_name", columnDefinition = "VARCHAR(255) DEFAULT '' COMMENT '表名'", nullable = false)
    var tableName: String = "",
    @Column(name = "template_info", columnDefinition = "LONGTEXT COMMENT '模板信息JSON'", nullable = false)
